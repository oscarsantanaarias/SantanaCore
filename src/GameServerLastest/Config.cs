...
namespace Santana
{
    public class Config
    {
        private static readonly string _configFilePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "GameServer.hjson");
        public static void Load()
        {
            ...
            {
                var hjsonText = HjsonValue.Load(stream).ToString(Stringify.Plain);
                Instance = JsonConvert.DeserializeObject<Config>(hjsonText);
            }
        }
        static Config()
        {
        ...
        [JsonProperty("redis")] public string Redis { get; set; }
        ...
        public void Save()
        {
            ...
            File.WriteAllText(_configFilePath, JsonValue.Parse(serialized).ToString(Stringify.Hjson));
        }
    }
    ...
    public class GameSettings
    {
        public GameSettings()
        {
            ...
            CaptainExpRates = new CaptainExperienceRates();
            SiegeExpRates = new SiegeExperienceRates();
        ...
        [JsonProperty("exp_rates_captain")] public CaptainExperienceRates CaptainExpRates { get; set; }
        [JsonProperty("exp_rates_siege")] public SiegeExperienceRates SiegeExpRates { get; set; }
        [JsonProperty("exp_rates_warfare")] public WarfareExperienceRates WarfareExpRates { get; set; }
    }
    ...
    public class CaptainExperienceRates : ExperienceRates
    {
        [JsonProperty("exp_per_first_point")] public float ExpPerFirstPoint { get; set; } = 5f;
        [JsonProperty("exp_per_second_point")] public float ExpPerSecondPoint { get; set; } = 3f;
        [JsonProperty("exp_per_third_point")] public float ExpPerThirdPoint { get; set; } = 2f;
        [JsonProperty("exp_per_captainkill")] public float ExpPerCaptainKill { get; set; } = 2f;
    }
    public class WarfareExperienceRates : ExperienceRates
    {
        [JsonProperty("exp_per_first_point")] public float ExpPerFirstPoint { get; set; } = 5f;
        [JsonProperty("exp_per_second_point")] public float ExpPerSecondPoint { get; set; } = 3f;
        [JsonProperty("exp_per_third_point")] public float ExpPerThirdPoint { get; set; } = 2f;
        [JsonProperty("exp_per_queenkill")] public float ExpPerQueenKill { get; set; } = 2f;
    }
    public class SiegeExperienceRates : ExperienceRates
    {
        [JsonProperty("exp_per_first_point")] public float ExpPerFirstPoint { get; set; } = 5f;
        [JsonProperty("exp_per_second_point")] public float ExpPerSecondPoint { get; set; } = 3f;
        [JsonProperty("exp_per_third_point")] public float ExpPerThirdPoint { get; set; } = 2f;
